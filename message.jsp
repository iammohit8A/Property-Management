                            ...
                            <tr>
                                   <td class="view-message center-block" >
                                       <div  style="width:100%; border:2px solid black; padding:15px;">
                                           <p id="klp">  <b><%=rs.getString("Cname")%> </b> is Interested to buy your <b><%=rs.getString("SiteName")%></b> Site.<br> His Mobile No:- <b><%=rs.getLong("Cmobile")%></b> , E-mail Id:- <b><%=rs.getString("Cemail")%></b> and He Send a Message For U..</p>
