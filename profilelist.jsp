            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active" style="display:<%=er%>;"><a href="profilelist.jsp"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">All Client Profile</span></a></li>
                ...
                <div class="user-dashboard">
                     <% 
                            ...
                            con=ConnectDB.connect();
                              ...
                              ResultSet   rs=st.executeQuery("select * from registration where userlog='client'");
                                 Boolean s1=rs.next();
                                     if(s1==false)
                                     {%>
                                         <h3 style="background:#0d172e; color:white; text-align:center;padding:10px;">Your Client Profile List is empty </h3>
                                         <%
                                     }
                                     else{
                    ...
                    <table border="3" id="table" class="table-responsive" >
                        ...
                        <th>#</th><th>User Id</th><th>User Name</th><th>Address</th><th>Profession</th><th>Mobile</th><th>E-Mail</th><th>Photo</th>
                        ...
                        <tr >
                            <td><input type="checkbox" name="check" value="<%=rs.getString("USERID")%>"></td>
                            <td><%=rs.getString("USERID")%></td>
                            <td><%=rs.getString("UserName")%></td>
                            <td><%=rs.getString("Address")%></td>
                            <td><%=rs.getString("Profession")%></td>
                            <td><%=rs.getLong("COntact_No")%></td>
