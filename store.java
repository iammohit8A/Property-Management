...
public class store extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException
    {
        ...
        try{
          ...
          PreparedStatement ps=Con.prepareStatement("insert into registration(USERID,UserName,Password,Profession,Contact_No,E_mail,Address,userlog,Photo) value(?,?,?,?,?,?,?,?,?)");
      ...
      while(rs.next()) {
        ...
        z=rs.getInt("S_no")+z;
           ...
           ps.setString(4, req.getParameter("Profession"));
           ps.setLong(5, Long.parseLong(req.getParameter("Contact")));
