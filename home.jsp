                ...
                <div class="user-dashboard">
                    ...
                    <div class="inbox-head">
                        ...
                        <table class="table table-inbox table-hover">
                           <tbody>
                            ...
                            con=ConnectDB.connect();
                              ...
                              ResultSet   rs=st.executeQuery("select * from buy Where UserId='"+s+"'");
                                 Boolean s1=rs.next();
                                     if(s1==false)
                                     {%>
                     ...
                     %>
                            ...
                            <tr>
                                   <td class="view-message center-block">
                                       <form action="message.jsp" method="post">  <button class="btn " type="submit" id="qw" title="Click For View Notification.." name="message" value="<%=rs.getString("Cmessage")%>"> <span class="glyphicon glyphicon-envelope"  aria-hidden="true"></span> <b> <%=rs.getString("Cname")%>  </b> is Interested in your <b><%=rs.getString("SiteName")%></b> Site & You Got A Message.. <span style="float: right;"> <%=rs.getString("Cdate")%></span></button></form>
                                   </td>
                               </tr>
                               <%
                                   }while(rs.next());
