...
<html>
    ...
    <body class="home">
        <% String ph="C:/Users/IAMOHIT/Documents/NetBeansProjects/WebApplication1/web/images/"+session.getAttribute("pic");%>
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="index.jsp"><img src="images/logo2.png" alt="logo" class="hidden-xs hidden-sm">
                   ...
                   <%
                    ...
                    Statement st=con.createStatement();
                              ...
                              Boolean s1=rs.next();
                                     if(s1==false)
                                     {%>
                                        <h3 style="background:#0d172e; color:white; text-align:center;padding:10px;">
                                            You haven't Add Any Property yet<br>
                                            Please add Your Site... </h3>
                                        <%
                                     }
                                     else{
                              %>
            ...
            <p id="o5p"><b><u>RECENT ADDED PROPERTY</u></b></p>
             <%
                              ...
                              phl="C:/Users/IAMOHIT/Documents/NetBeansProjects/WebApplication1/web/images/"+rs.getString("Photo");
                    %>
            ...
            <div class="col-md-3 col-sm-5 "  id="o6" >
                ...
                <p style='font-size: 18px;'> <img src="C:/Users/IAMOHIT/Documents/NetBeansProjects/WebApplication1/web/images/in.png" height="20" weight="20"> <%=rs.getInt("Price")%> <b>/-</b></p>
                <form action='ShowDetail.jsp' method='post'>
                    <Button type="submit" value="<%=rs.getString("Site_Name")%>" name="detail" style="background:rgb(48, 88, 148); color:white;">See Details</button></form>
                ...
                <div class="modal-body " >
                    <input type="text" required="" placeholder="Site Name" name="sname" class="col-md-7" style="margin-right: 10px;">
                           ...
                           <input type="email"  required="" placeholder="E-Mail Id" name="semail" style="width:48%;">
                                                      <input type="text"  required="" placeholder="Img" name="sfile" style="width:48%;">
