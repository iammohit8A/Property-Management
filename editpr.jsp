        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
               ...
               <tr>
                ...
                <tr>
                    <td><h3>User Name: </h3> </td><td> <input type="text"  placeholder="<%=session.getAttribute("name") %>" name="name"></td>
                </tr>
                <tr>
                    <td><h3>Address: </h3> </td><td> <input type="text"  placeholder="<%=session.getAttribute("address") %>" name="address"></td>
                </tr>
                <tr>
                    <td><h3>Profession: </h3> </td><td> <input type="text"  placeholder="<%=session.getAttribute("kaam") %>" name="kaam"></td>
                </tr>
                <tr>
                    <td><h3>Mobile No: </h3> </td><td> <input type="text"  placeholder="<%=session.getAttribute("mobile") %>" name="mobile"></td>
                </tr>
               <tr>
                    <td><h3>E-mail: </h3> </td><td> <input type="email"  placeholder="<%=session.getAttribute("mail") %>" name="mail"></td>
                </tr>
                <tr>
                    <td><h3>Photo: </h3> </td><td> <input type="text"  placeholder="<%=session.getAttribute("file") %>" name="image"></td>
                </tr>
