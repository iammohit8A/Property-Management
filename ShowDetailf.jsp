...
<html>
    ...
    <body  style="background: rgb(48, 88, 148); color:white;" >
      ...
      <h2 id="pt"> $$ Property Details And Enquiry Form  $$</h2>
      </div>
    ...
    <ul class="comment-list">
        <% rs1=st.executeQuery("select * from registration Where USERID='"+ rs.getString("UserId")+"'");
			  ...
			  <div class="content-form">
                              <h2 style="color:white;"><b>:- Please Fill This Form for full Enquiry  -:</b></h2>
        ...
        <footer class="footer-distributed " style="padding-top:50px;">
			...
			<div class="footer-right" id="fl">
				...
				<p class="footer-company-about">
					...
					Knect is India's budding Real Estate startup which is currently working in metropolitan cities of India. 
				</p>
