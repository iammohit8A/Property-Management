    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="index.jsp"><img src="images/logo2.png" alt="Knect_logo" class="img-responsive" style="padding-top:  30px;padding-bottom: 5px;">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    ...
                                    <li><a href="#"><i class="fa fa-envelope" aria-hidden="true" title="Inbox"></i></a></li>
                                    <li>
                ...
                <th colspan="2" style="text-align: center; font-family: Alexuss Heavy; padding: 0px; background: #0e1a35;color:#5584ff;"><u>Profile</u></th>
                
                <tr>
                    <td><h3>User Id: </h3> </td><td> <%=session.getAttribute("id") %></td>
                </tr>
                <tr>
                    <td><h3>User Name: </h3> </td><td> <%=session.getAttribute("name") %></td>
                </tr>
                <tr>
                    <td><h3>Address: </h3> </td><td> <%=session.getAttribute("address") %></td>
                </tr>
                <tr>
                    <td><h3>Profession: </h3> </td><td> <%=session.getAttribute("kaam") %></td>
                </tr>
                <tr>
                    <td><h3>Mobile No: </h3> </td><td> <%=session.getAttribute("mobile") %></td>
                </tr>
               <tr>
                    <td><h3>E-mail:  </h3> </td><td> <%=session.getAttribute("mail") %></td>
                </tr>
                <tr>
                    <td><h3>Photo: </h3> </td><td style="text-align: center;"> <img src="<%=ph%>" height="40px" weight="70px" style="border-right: 50%; border:1px solid #0e1a35;"></td>
                </tr>
                <tr >
                    <td colspan="2" style="text-align: center;"><a href="#"  data-toggle="modal" data-target="#add_project" ><button class="btn btn-success" id="sb">Change Password</button></a> <a href="editpr.jsp"><button class="btn btn-info" id="sb" >Edit Profile</button></a> </td>
                </tr>
    ...
    <div id="add_project" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="upass" method="post" >
                
                        <div class="modal-body" >
                            <input type="Password" required="required" placeholder="Old Password" name="oldp" style="width: 100%" >
                            <input type="Password" required="required"  placeholder="New Password " name="newp" style="width: 100%">
                            <input type="Password" required="required"  placeholder="Confirm Password " name="newcp"style="width: 100%" >
