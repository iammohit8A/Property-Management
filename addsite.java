...
return null;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into site(UserId,Site_Name,Price,Area,BedRoom,BathRoom,Location,Mobile,Address,Email,Photo,Description) value(?,?,?,?,?,?,?,?,?,?,?,?)");
           ps.setString(1, (String) session.getAttribute("id"));
            ...
            ps.setLong(8, Long.parseLong(request.getParameter("snumber")));
            ps.setString(9, request.getParameter("saddress"));
          ...
          s3=imageName;
                 ...
                 String basePath = "C:\\Users\\IAMOHIT\\Documents\\NetBeansProjects\\WebApplication1\\web\\images\\";
